#!/bin/bash
# Evaluate decoder fine-tuning checkpoints (LoRA, Qwen3Bi) across multiple GPUs.

MODEL_DIR=output/finetune/decoder             # directory containing checkpoint-* subdirs
POOL=mean
CKPT_TYPE=lora                                # LoRA checkpoints need base model for merge
